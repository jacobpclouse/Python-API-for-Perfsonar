...
# --- Function to raise exception on Timeout
# From: https://stackoverflow.com/questions/36762283/skip-loop-if-a-function-is-taking-too-long
...
# -- need to make funciton: 
# getTestResults(uri,key,jsonOfTests,dateTime,currentCount,directory,server)
...
'''
    ...
    for test in test_data_URIs:
        ...
        # Current Prefix for this file
        #current_server_prefix = f'{test}_{newDirectory}_'
        current_server_prefix = f'{test}_{count}_{metaDataKey}_{use_this_datetime}_'
